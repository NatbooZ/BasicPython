...
if __name__ == '__main__':
	...
	speacial_student = SpecialStudent('จ้อย',16,'ชาย','นายก อบต.เจท')
	...
	print('------8.45 น.-----')
	speacial_student.sawatdee()
	speacial_student.hello('ครู')
	print('เดินไปที่โต๊ะของตัวเอง')
	speacial_student.hello('เพื่อน')
	print(f'ครู{teacher1.name}! ขอเกรดดีๆหน่อย')
	speacial_student.myfather()
